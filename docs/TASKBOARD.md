...
| 날짜 | 구분 | 내용 | 커밋해시 |
|------|------|------|---------|
| 2026-05-17 | feat | T-033 텔레메트리 backfill — included_data 없는 매치 210개 재수집 스크립트 | 834c086 |
| 2026-05-17 | feat | T-032 히트맵 맵 표시명 수정(Baltic→에란겔 등) + 랜드마크 키 수정 + 배경 이미지 로컬폴백 | d98b0f5 |
