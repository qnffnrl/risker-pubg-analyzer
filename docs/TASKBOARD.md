...
> 최종 갱신: 2026-05-17 (T-018 관리자 페이지 main 병합)
...
| ID | 작업명 | 유형 | PRD | 진행률 |
|----|--------|------|-----|--------|
| T-019 | 공유 기능 (OG 이미지 동적 생성 + PNG 저장) | feat | [PRD](prd/T-019-PRD-20260516-share-feature.md) | 100% |
...
| 날짜 | 구분 | 내용 | 커밋해시 |
|------|------|------|---------|
| 2026-05-17 | feat | T-019 공유 기능 — /api/og 동적 OG 이미지(Edge Runtime), generateMetadata OG/Twitter 태그, 링크 복사 버튼(2초 복사됨! 피드백), PNG 저장 버튼 | - |
