...
| ID | 상태 | 제목 | PRD 파일 | 완료일 |
|----|------|------|---------|--------|
| T-001 | 📋 대기 | 모노레포 스캐폴딩 (Next.js + Hono + BullMQ) | [T-001](T-001-PRD-20260516-monorepo-scaffold.md) | - |
...
| ID | 상태 | 제목 | PRD 파일 | 완료일 |
|----|------|------|---------|--------|
| T-008 | 📋 대기 | 플레이어 검색 페이지 (랜딩/홈) | [T-008](T-008-PRD-20260516-search-page.md) | - |
| T-009 | 📋 대기 | 플레이어 프로필 + 매치 목록 페이지 | [T-009](T-009-PRD-20260516-player-profile-page.md) | - |
| T-010 | 📋 대기 | 플레이 스타일 분석 대시보드 (레이더 차트) | [T-010](T-010-PRD-20260516-analysis-dashboard.md) | - |
| T-012 | 📋 대기 | 로컬 스토리지 (최근 검색 + 즐겨찾기, 로그인 없음) | [T-012](T-012-PRD-20260516-local-storage.md) | - |

### Phase 4: 고도화 기능

| ID | 상태 | 제목 | PRD 파일 | 완료일 |
|----|------|------|---------|--------|
| T-011 | 📋 대기 | LLM 성향 자연어 요약 (Claude API) | [T-011](T-011-PRD-20260516-llm-summary.md) | - |
| T-013 | 📋 대기 | 플레이어 비교 기능 (오버레이 레이더 차트) | [T-013](T-013-PRD-20260516-player-comparison.md) | - |
